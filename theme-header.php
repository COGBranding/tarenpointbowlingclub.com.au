...
<?php ob_start(); ?>
	<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
		...
		<div class="container contact-links">
			<a class="contact-links__item contact-links__item--phone" href="tel:+61295228111">02 9522 8111</a>
			<a class="contact-links__item contact-links__item--location" href="https://goo.gl/maps/JYnkQKgiwTGGrwtz5" target="_blank">203 Holt Rd, Taren Point NSW 2229</a>
			<a class="contact-links__item contact-links__item--hours">Mon - Sun: 9am - Late</a>
		</div> <!-- .contact-links -->
